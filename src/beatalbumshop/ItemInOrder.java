...
//    Customer customer = (Customer) LoggedInUser.getCurrentUser();
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ArrayList<Item> lOrderItem = order.getlOrderItem();
        for(Item item : lOrderItem) {
            if(item.getAlbumID().equals(albumID)) {
                lOrderItem.remove(item);
                break;
            }
        }
        ...
        //reset
        orderDetail.displayItemInOrder();
    ...
    private void cboQuantityItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cboQuantityItemStateChanged
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED && OtherHelper.getMainAdminFrame(this) != null) {
